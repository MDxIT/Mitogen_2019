...
class ResultOrganizer(object):
  ...
  def createResDict(self):
    ...
    resDict['resultCode'] = ''
    resDict['analysisDataDefinitionId'] = ''
    resDict['originalResult'] = '' 
  ...
  def organizeByResult(self, resultList):
    ...
    for res in resultList:
      ...
      resultDict['originalResult'] = res['originalResult']
      ...
      resultDict['analysisDataDefinitionId'] = res['analysisDataDefinitionId']
