...
def insertReportResultDataNoSpecimen(switchboard, reportDetailsId, panelCode, varcharReviewResult, interpretation, wording, isOverall, isPanelOverall, eventId):
  ...
  try:
    ...
    insertReportResultData = '''
      INSERT INTO reportResultData (reportDetailsId, panelCode, varcharReviewResult, interpretation, wording, isOverall, isPanelOverall, lastUpdatedEventId, eventId)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    '''
    ...
    insertReportResultDataQueryStmt.setString(3, varcharReviewResult)
...
def insertReportResultData(switchboard, reportDetailsId, specimenId, panelCode, testCode, methodCode, analysisDataId, varcharResult, varcharReviewResult, decimalResult, decimalReviewResult, dateTimeResult, dateTimeReviewResult, imageResult, interpretation, wording, isOverall, isPanelOverall, limits, reportableUnits, eventId):
  ...
  try:
    ...
    if decimalReviewResult == '':
      decimalReviewResult = None

    if dateTimeResult == '':
      dateTimeResult = None 

    if dateTimeReviewResult == '':
      dateTimeReviewResult = None
    elif dateTimeReviewResult != None:
      dateObj = DateFormatter(switchboard, dateTimeReviewResult)
      dateTimeReviewResult = dateObj.shortFormToDataBaseStr()
    ...
    insertReportResultData = '''
      INSERT INTO reportResultData (reportDetailsId, specimenId, panelCode, testCode, methodCode, analysisDataId, varcharResult, varcharReviewResult, decimalResult, decimalReviewResult, dateTimeResult, dateTimeReviewResult, imageResult, interpretation, wording, isOverall, isPanelOverall, limits, reportableUnits, lastUpdatedEventId, eventId)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    '''
    ...
    insertReportResultDataQueryStmt.setString(8, varcharReviewResult)
    insertReportResultDataQueryStmt.setString(9, decimalResult)
    insertReportResultDataQueryStmt.setString(10, decimalReviewResult)
    insertReportResultDataQueryStmt.setString(11, dateTimeResult)
    insertReportResultDataQueryStmt.setString(12, dateTimeReviewResult)
    insertReportResultDataQueryStmt.setString(13, imageResult)
    insertReportResultDataQueryStmt.setString(14, interpretation)
    insertReportResultDataQueryStmt.setString(15, wording)
    insertReportResultDataQueryStmt.setInt(16, isOverall)
    insertReportResultDataQueryStmt.setInt(17, isPanelOverall)
    insertReportResultDataQueryStmt.setString(18, limits)
    insertReportResultDataQueryStmt.setString(19, reportableUnits)
    insertReportResultDataQueryStmt.setLong(20, eventId)
    insertReportResultDataQueryStmt.setLong(21, eventId)
    print insertReportResultDataQueryStmt  
...
def insertReportResultDataAmend(switchboard, reportDetailsId, specimenId, panelCode, testCode, methodCode, analysisDataId, newValueType, newResult, originalResult, interpretation, wording, isOverall, isPanelOverall, limits, reportableUnits, previousReportResultDataId, eventId):
  ...
  try:
    ...
    if newValueType == 'dateTime':
      ...
      if dateTimeResult == '':
        dateTimeResult = None
      dateTimeReviewResult = newResult
      if dateTimeReviewResult == '':
        dateTimeReviewResult = None
      else:
        dateObj = DateFormatter(switchboard, dateTimeReviewResult)
    ...
    insertReportResultData = '''
      INSERT INTO reportResultData (reportDetailsId, specimenId, panelCode, testCode, methodCode, analysisDataId, varcharResult, varcharReviewResult, decimalResult, decimalReviewResult, dateTimeResult, dateTimeReviewResult, imageResult, interpretation, wording, isOverall, isPanelOverall, limits, reportableUnits, previousReportResultDataId, lastUpdatedEventId, eventId)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    '''
    ...
    insertReportResultDataQueryStmt.setString(18, limits)
    insertReportResultDataQueryStmt.setString(19, reportableUnits)
    insertReportResultDataQueryStmt.setString(20, previousReportResultDataId)
    insertReportResultDataQueryStmt.setLong(21, eventId)
    insertReportResultDataQueryStmt.setLong(22, eventId)
    print insertReportResultDataQueryStmt  
...
def updateReportResultData(switchboard, varcharResult, varcharReviewResult, decimalResult, decimalReviewResult, dateTimeResult, dateTimeReviewResult, imageResult, interpretation, wording, lastUpdatedEventId, reportResultDataId):
  ...
  try:
    ...
    updateReportResultDataQueryStmt.setString(2, varcharReviewResult)
    updateReportResultDataQueryStmt.setString(3, null_if_blank(decimalResult))
    updateReportResultDataQueryStmt.setString(4, null_if_blank(decimalReviewResult))
    updateReportResultDataQueryStmt.setString(5, dateTimeResult)
    updateReportResultDataQueryStmt.setString(6, dateTimeReviewResult)
    updateReportResultDataQueryStmt.setString(7, imageResult)
    updateReportResultDataQueryStmt.setString(8, interpretation)
    updateReportResultDataQueryStmt.setString(9, wording)
    updateReportResultDataQueryStmt.setLong(10, lastUpdatedEventId)
    updateReportResultDataQueryStmt.setString(11, reportResultDataId)
