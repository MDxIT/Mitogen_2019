...
$(document).ready(function() {
  ...
  $('#mapType').on('change', function() {
    ...
    if(mapType == 'Tray Map') {
      ...
      $('.traymapOptions').attr("data-parsley-required", "true");
      $transferMap.hide();
      ...
      $('.traymapOptions').val('');
      $transferMap.show();
      $('.transfermapOptions').attr("data-parsley-required", "true");
    } else {
      $trayMap.hide();
      $transferMap.hide();
      $('.transfermapOptions').val('');
      $('.traymapOptions').val('');
      $('.transfermapOptions').attr("data-parsley-required", "false");
      $('.traymapOptions').attr("data-parsley-required", "false");
    }
  }).trigger('change');
